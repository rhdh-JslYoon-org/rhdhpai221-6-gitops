...
# Application
An application built from https://github.com/rhdh-JslYoon-org/rhdhpai221-6 will be stored in [quay.io/rh-ee-lyoon/rhdhpai221-6](https://quay.io/rh-ee-lyoon/rhdhpai221-6) and deployed through GitOps. This application is accessible on port **8501**.